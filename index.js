        ...
        <div class="cart-form__item" id="item-${item.id}">
          <div class="cart-form__item-info">
            ...
            <div class="cart-form__item-text">
              <div class="cart-form__item-price-value-mobile">
                ...
                <p class="cart-form__price-old">1051 <span class="cart-form__item-price-currency cart-form__price-old">сом</span></p>
              </div>
              ...
              <div class="cart-form__item-storage">
                ...
                <div class="cart-form__item-provider">
                  ...
                  <svg class="cart-form__info-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="cart-form__item-price">
            <div class="cart-form__item-price-buttons">
              ...
              <label class="cart-form__item-price-label" for="count">Осталось ${
                item.max - item.count
              } шт.</label>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const nameInput = document.getElementById('user-form')
...
function handleCheckboxChange(id) {
  ...
  if (id == 0) {
    ...
    console.log(isAllChecked, mainCheckbox)
